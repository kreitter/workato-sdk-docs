...
> **Fetched**: 2026-09-21T02:19:34.086781
...
[](<https://www.workato.com/>)/[docs](</en>)
  ...
  * [ English](</en/developing-connectors/sdk/guides/best-practices>)
  * [ 日本語](</ja/developing-connectors/sdk/guides/best-practices>)
...
### Memory management [​](<#trigger-memory-management>)
  ...
  * **Optimize memory usage in triggers**
    ...
    * Avoid downloading all data at once without pagination.
