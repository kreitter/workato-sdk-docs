...
> **Fetched**: 2026-09-25T02:14:57.394737
...
[](<https://www.workato.com/>)/[docs](</en>)
  ...
  * [ English](</en/developing-connectors/sdk/cli/guides/cli/test>)
  * [ 日本語](</ja/developing-connectors/sdk/cli/guides/cli/test>)
...
Are you an LLM? You can read better optimized documentation at /en/developing-connectors/sdk/cli/guides/cli/test.md for this page in Markdown format
