...
> **Fetched**: 2026-09-22T02:16:57.305317
...
[](<https://www.workato.com/>)/[docs](</en>)
  ...
  * [ English](</en/developing-connectors/sdk/guides/building-actions/multistep-actions>)
  * [ 日本語](</ja/developing-connectors/sdk/guides/building-actions/multistep-actions>)
...
You can't debug multistep actions in Workato's SDK **Test code** tab. This may trigger an `uncaught throw :return_from_action` error. Instead, use the [SDK Gem](</en/developing-connectors/sdk/cli>) to debug multistep actions.
