...
> **Fetched**: 2026-09-20T02:16:21.201422
...
[](<https://www.workato.com/>)/[docs](</en>)
  ...
  * [ English](</en/developing-connectors/sdk/guides/building-triggers/securing-webhooks>)
  * [ 日本語](</ja/developing-connectors/sdk/guides/building-triggers/securing-webhooks>)
...
[See the full connector in our community library](<https://app.workato.com/custom_adapters/543633/details?community=true>).

## Step 1 - Setting the webhook_payload_type to raw if needed [​](<#step-1-setting-the-webhook-payload-type-to-raw-if-needed>)
