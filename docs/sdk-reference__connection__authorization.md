...
> **Fetched**: 2026-06-24T03:12:06.063147
...
```ruby
        ...
        authorization_url: lambda do |connection| "https://acme.com/api/oauth/authorization?response_type=code"
    end,
...
![](/assets/identity_lambda.SMwsdN23.png)
...
Expected output| A string containing details about the connection (for example, "[[email protected]](</cdn-cgi/l/email-protection#8afff9eff8caeff2ebe7fae6efa4e9e5e7>)", "Refresh token expires in 86400 seconds")  
|   
Example - identity
