...
> **Fetched**: 2026-09-26T02:15:35.214879
...
[](<https://www.workato.com/>)/[docs](</en>)
  ...
  * [ English](</en/developing-connectors/sdk/guides/building-triggers/static-webhook>)
  * [ 日本語](</ja/developing-connectors/sdk/guides/building-triggers/static-webhook>)
...
## Step 1 - Set up the webhook_keys attribute and retrieve your connector static webhook URL [​](<#step-1-set-up-the-webhook-keys-attribute-and-retrieve-your-connector-static-webhook-url>)
...
![Static webhook URL](/assets/static_webhook_url.B8S2rZCc.png)_Static webhook URL in**Test code** environment_
...
![New event output fields](/assets/event_output.DvnJkNsb.png)_New event output fields_
